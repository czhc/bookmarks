...
- [ ] Tokenizing [Future Yield](https://www.coingecko.com/buzz/tokenizing-future-yield)
    * 
...
- [ ] Yearn Vesting [Escrow contract](https://github.com/banteg/yearn-vesting-escrow) based on CurveDAO and Aragon Voting App - vesting contracts
