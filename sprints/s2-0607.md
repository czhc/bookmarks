...
- [ ] [6.](https://www.youtube.com/watch?v=JPkgJwJHYSc&t=9s) Smart Contracts and DApps
    ...
    * everything else in cryptography, consensus is the same as bitcoin (in POW). 
- [ ] [CDC](https://digitalchamber.org/wp-content/uploads/2018/02/Smart-Contracts-12-Use-Cases-for-Business-and-Beyond_Chamber-of-Digital-Commerce.pdf) - Smart Contract Use Cases
    * Digital Identity
    * Securities
    * Trade Finance
    * Derivatives
