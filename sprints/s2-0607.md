...
_hypersurface_: ordinary surface in three-dimensional space to the case of an n- dimensional space.

- [x] AMM with [dynamic peg](https://curve.fi/files/crypto-pools-paper.pdf)
    * _liquidity for assets which
aren’t interpegged, but more efficient than xy = k_
...
the increase of Xcp)._
    ...
    * _safe values for converging D: 1<A<10E4, 10E-9 < x0 (based currency) <10E15, 10E-5 < xi/x0 (price ratios) < 10E5, 10E-8 < γ < 10E-2
