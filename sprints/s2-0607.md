...
- [ ] [Byzantine General's problem](http://lamport.azurewebsites.net/pubs/byz.pdf) - how to achieve consensus in a distributed system with no central authority, and risks of bad actors.
    * 
