...
- [ ] Understanding Curve 
    - [ ] [StableSwap Exchange](https://curve.fi/files/stableswap-paper.pdf) for stablecoin / pegged-assets liquidity
    - [ ] AMM with [dynamic peg](https://curve.fi/files/crypto-pools-paper.pdf)
    - [ ] [Pools](https://curve.readthedocs.io/exchange-pools.html#exchange-pools-a)
        ...
        * Stableswap curve looks more like Constant Sum than Constant Product (see Constant Function MMs)
- [ ] [Constant Function](https://medium.com/bollinger-investment-group/constant-function-market-makers-defis-zero-to-one-innovation-968f77022159) Market Makers: 
    * Constant Product: 
    * Constant Sum: 
    * Constant Mean:
    * Hybrid CFMMs:
