...
- [ ] Bitcoin, the [Mises Regression Theorem](https://mises.org/library/bitcoin-regression-theorem-and-emergence-new-medium-exchange) and emergency of a new medium of exchange
    - [ ] El Salvador passes Bitcoin as [legal tender](https://twitter.com/nayibbukele/status/1402446890466217985)
...
- [ ] Snapshot: decentralized [voting](https://decrypt.co/resources/what-is-snapshot-the-decentralized-voting-system)
