...
- [ ] Smart Contract Weakness [(SWC) registry](https://swcregistry.io/)
...
- [x] [EIP-1822](https://eips.ethereum.org/EIPS/eip-1822): Universal Upgradeable Proxy Standard
...
- [x] [EIP-1967](https://ethereum-blockchain-developer.com/110-upgrade-smart-contracts/09-eip-1967/): Standard Proxy Storage slots
    ...
    * already implemented by open zepellin `UpgradeabilityProxy`
    - [x] Open Zep [Proxy](https://docs.openzeppelin.com/contracts/3.x/api/proxy#Proxy)
...
- [ ] [ToB](https://blog.trailofbits.com/2018/09/05/contract-upgrade-anti-patterns/): Contract upgrade anti-patterns
...
- [x] Baller: Impermanent loss in Balancer Pools