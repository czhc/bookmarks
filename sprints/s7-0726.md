...
- [ ] [Paxos Trust Company](paxos.com): provides a suite of banking/finance solutions including brokerage, exchange, stablecoin and securities+commodities settlement
   * Paxos products include: 
   ...
   - [ ] (Apr 2021) Instinet and Credit Suisse now has [same-day settlement (T+0)](https://www.paxos.com/instinet-and-credit-suisse-conduct-same-day-settlement-of-traded-stocks-in-historic-first-with-paxos-settlement-service/) with Paxos Settlement for US listed equities
      * including intra trades executed after 11AM (legacy requires same-day trades to be executed before 11AM)

- [ ] [Paxos](https://www.coindesk.com/paxos-becomes-latest-crypto-firm-to-file-for-federal-bank-charter) files for Federal Bank Charter
