...
- [ ] [22.](https://www.youtube.com/watch?v=DsSzQfejwMk) Trade Finance and Supply Chain
   ...
   * **Cost of trust between _multiple parties_** is the specific challenge that cannot be solved by simply _digitizing_ trade finance. Cost of trust in the network is _2^n_ for each trade.
      - [ ] [Fraud in Trade finance](https://www.gtreview.com/magazine/volume-19-issue-1/legal-roundtable-learning-lessons-trade-finance-fraud/): cases ultimately involve double-funding invoices: two or more banks are duped into financing one invoice. 
         * SG-based traders left combined total exposure of US5B.
   * Blockchain solutions in Trade Finance
      - [ ] [Contour Blockchain](https://contour.network/) - formerly [Voltron](https://www.bain.com/about/media-center/press-releases/2018/trade-finance-solution-voltron-launches-open-platform-on-corda-blockchain/)
      - [ ] [Marco Polo](https://www.marcopolonetwork.com/articles/supply-chain-finance/?redirect=true) on Corda
      - [ ] [We.Trade](https://www.ibm.com/blogs/blockchain/2021/03/blockchain-and-trade-finance/) on IBM HF.
   * Blockchain projects in supply-chain:
      - [ ] [DeBeers diamonds](https://www.reuters.com/article/us-anglo-debeers-blockchain-idUSKBN1F51HV)
      - [ ] [Walmart](https://digital.hbs.edu/platform-rctom/submission/walmart-from-supply-chain-to-blockchain/) 
- [ ] [Trade Tech](https://www.weforum.org/whitepapers/trade-tech-a-new-age-for-trade-and-supply-chain-finance): A New Age for Trade and Supply Chain Finance
...
- [ ] [Secret Network](https://scrt.network/blog/sefi-governance-live-mainnet-private-voting): World's first private voting application on public blockchain
