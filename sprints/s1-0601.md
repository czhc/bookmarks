...
- [ ] Nakamoto, Satoshi. Bitcoin P2P e-cash paper [email](https://www.metzdowd.com/pipermail/cryptography/2008-October/014810.html), [whitepaper](https://bitcoin.org/bitcoin.pdf)
  ...
  * How are bitcoin txns divisble? [wiki](https://en.bitcoin.it/wiki/Transaction) - an Input just a reference to an Output from a previous txn. A current wallet's balance the sum of all Inputs i.e. sum of all Outputs from multiple txns pointing to the wallet's address. 
  * ![Transaction](https://en.bitcoin.it/wiki/File:Transaction.png)
  * 
